...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadMining() async {
    ...
    if (serverRemaining > 0) {
      ...
      remaining = finalEnds.difference(DateTime.now());
    ...
    if (serverElapsed > 0) {
      ...
      elapsed = DateTime.now().difference(finalStarted);
  ...
  void _startTimer() {
    ...
    _timer = Timer.periodic(
      ...
      (_) {
        ...
        Duration remaining = _endsAt!.difference(now);
        ...
        if (_startedAt != null) {
          ...
          elapsed = miningDuration - remaining;
  ...
  Future<void> _startMining() async {
    ...
    try {
      ...
      if (mounted) {
        _message('Mining started successfully.');
      }
    } catch (e) {
      if (mounted) {
        _message(_error(e));
  ...
  Widget _buildMiningCard() {
    final finished = _canClaim && !_isMining;
            ...
            children: [
              ...
              Expanded(
                child: _miningInfo(
                  ...
                  'SESSION TIME',
                  '${_formatDuration(_elapsed)} / 24:00:00',
                ),
              ),
            ],
          ),
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                disabledBackgroundColor:
                    primaryPurple.withOpacity(0.65),
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Text(
                'Ads watched today: $_adsWatched / $_maxAds',
                style: const TextStyle(
                  color: deepPurple,
                  fontWeight: FontWeight.w600,
                ),

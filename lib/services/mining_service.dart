...
class MiningService {
  ...
  //
  // IMPORTANT:
  // The backend claim_mining() must verify the real server time.
  // Flutter must NOT decide that 24 hours has finished.
  // ------------------------------------------------------------

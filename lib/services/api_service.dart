...
class ApiService {
  ...
  static Future<Map<String, dynamic>> startMining() async {
    ...
    if (active) {
      throw Exception('Mining is already active.');
    }
  ...
  static Future<Map<String, dynamic>> claimMining() async {
    ...
    final endsAtString =
        profile['mining_ends_at']?.toString();
    ...
    final endsAt =
        DateTime.tryParse(endsAtString);
  ...
  static Future<Map<String, dynamic>>
    ...
    final newReferrerCount =
        referrerCount + 1;

    final newReferrerRate =
        0.2 +
        newReferrerCount * 0.02;
    ...
    if (lastClaim != null &&
      ...
      if (previous != null) {
        ...
        if (difference.inHours < 24) {
          throw Exception(
            'Daily social reward has already been claimed.',
          );
        }
      }
    }

...
const Color powerPurple =
    Color(0xFF4217B8);

const Color powerPurpleDark =
    Color(0xFF2B0B78);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<AppUpdateInfo>(
      ...
      builder: (
        ...
        /*
         * If the version check itself fails,
         * allow the app to continue.
         *
         * The server-side mining protection
         * should also be added later so old
         * versions cannot perform mining RPCs.
         */

...
class AppState extends ChangeNotifier {
  ...
  bool _miningActive = false; DateTime? _miningEndsAt; int _dailyAdsWatched = 0; int _activeReferrals = 0;
  String? _error; bool _loading = true; Map? _user;

  double get fanBalance => _fanBalance; double get afamBalance => _afamBalance; double get miningRate => _miningRate;
  bool get miningActive => _miningActive; int get dailyAdsWatched => _dailyAdsWatched; int get activeReferrals => _activeReferrals;
  String? get error => _error; bool get loading => _loading; Map? get user => _user;
  ...
  Future<void> refresh() async {
    ...
    try {
      ...
      if(profile != null) {
        _user = profile;
        _fanBalance = ApiService.toDouble(profile['fan_balance']);
        _afamBalance = ApiService.toDouble(profile['afam_balance']);
        _miningRate = ApiService.toDouble(profile['mining_rate'], fallback: 0.2);
        ...
        _dailyAdsWatched = ApiService.toInt(profile['daily_ads_watched']);
        _activeReferrals = ApiService.toInt(profile['active_referrals']);
      }
  ...
  Future<void> logout() async {await ApiService.clearToken();}
}

...
class HomePage extends StatelessWidget { const HomePage({super.key}); @override Widget build(BuildContext context) {
  final app = context.watch<AppState>();
  return SafeArea(child: RefreshIndicator(onRefresh: app.refresh, child: ListView(padding: EdgeInsets.all(16), children: [
    ...
    Card(child: Padding(padding: EdgeInsets.all(18), child: Column(children: [
      ...
      SizedBox(width: double.infinity, height: 50, child: ElevatedButton(
        ...
        child: Text(app.miningActive? "CLAIM MINING" : "START MINING"), style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF3B159B), foregroundColor: Colors.white))))
    ])))
  ])));
}}
